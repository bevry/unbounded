...
<span class="badge-travisci"><a href="http://travis-ci.org/bevry/unbounded" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/bevry/unbounded/master.svg" alt="Travis CI Build Status" /></a></span>
...
<li>Module: <code>require('unbounded')</code></li></ul>
...
<li>Install: <code>ender add unbounded</code></li>
<li>Module: <code>require('unbounded')</code></li></ul>
...
<ul><li><code>unbounded</code> aliases <code>unbounded/index.js</code> which uses <a href="https://github.com/bevry/editions" title="Editions are the best way to produce and consume packages you care about.">Editions</a> to automatically select the correct edition for the consumers environment</li>
<li><code>unbounded/source/index.js</code> is Source + <a href="https://babeljs.io/docs/learn-es2015/" title="ECMAScript Next">ESNext</a> + <a href="https://nodejs.org/dist/latest-v5.x/docs/api/modules.html" title="Node/CJS Modules">Require</a></li>
<li><code>unbounded/es2015/index.js</code> is <a href="https://babeljs.io" title="The compiler for writing next generation JavaScript">Babel</a> Compiled + <a href="http://babeljs.io/docs/plugins/preset-es2015/" title="ECMAScript 2015">ES2015</a> + <a href="https://nodejs.org/dist/latest-v5.x/docs/api/modules.html" title="Node/CJS Modules">Require</a></li></ul>
